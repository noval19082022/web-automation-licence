...
Feature: Homepage
  ...
  @TEST_SS-3299 @Automated @SS12 @Web @discovery-platform @homepage
  Scenario: [Dweb][Homepage]Check cari iklan dropdown items
    Given user go to mamikos homepage
    Then tenant can see ads dropdown option

  @TEST_SS-3298 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3295 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3294 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3303 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3300 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3274 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3276 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3277 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3288 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3284 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3280 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3287 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3285 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3302 @Automated @SS12 @Web @discovery-platform @homepage
...
#	@TEST_COOP-4856 @Automated @SS12 @Web @discovery-platform @homepage
...
#		Then user should redirect to link "https://promo.mamikos.com/"
  ...
  @TEST_SS-3275 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3151 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3296 @Automated @SS12 @Web @discovery-platform @homepage
  ...
  @TEST_SS-3301 @Automated @SS12 @Web @discovery-platform @homepage
