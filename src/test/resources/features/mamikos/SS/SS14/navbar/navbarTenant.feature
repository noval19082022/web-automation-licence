@SS14 @NAVBAR_SEARCH_MIGRATE
Feature: Navbar Tenant

  @TEST_SS-3221 @Automated @SS14 @Web @discovery-platform @navbar @navbar-before-login @navbar-search
  ...
  @TEST_SS-3215 @Automated @SS14 @Web @discovery-platform @navbar @navbar-before-login @navbar-other @TEST_COOP-5676
  ...
  @TEST_SS-3201 @Automated @SS14 @Web @discovery-platform @navbar @navbar-before-login @navbar-other @TEST_COOP-5677
  Scenario: [Dweb][Navbar]Check Navbar in url mamikos-booking Page Before login
    Given user navigates to mamikos-booking
    Then navbar kost before login appears

  @TEST_SS-3203 @Automated @SS14 @Web @discovery-platform @navbar @navbar-before-login @navbar-other @TEST_COOP-5678
  Scenario: [Dweb][Navbar]Check Navbar in url mamikos-promo-kost Page Before login
    Given user navigates to mamikos-promo-kost
    Then navbar before login appears

  @TEST_SS-3198 @Automated @SS14 @Web @discovery-platform @navbar @navbar-before-login @navbar-other @TEST_COOP-5679
  ...
  @TEST_SS-3181 @Automated @SS14 @Web @discovery-platform @navbar @navbar-before-login @navbar-kost-detail
  ...
  @TEST_SS-3217 @Automated @SS14 @Web @discovery-platform @navbar @navbar-after-login @navbar-search
  ...
  @TEST_SS-3183 @Automated @SS14 @Web @discovery-platform @navbar @navbar-after-login @navbar-other
  ...
  @TEST_SS-5167 @Automated @SS14 @Web @discovery-platform @navbar @navbar-after-login @navbar-other
  ...
  @TEST_SS-5168 @Automated @SS14 @Web @discovery-platform @navbar @navbar-after-login @navbar-other
  ...
  @TEST_SS-5169 @Automated @SS14 @Web @discovery-platform @navbar @navbar-after-login @navbar-other
  ...
  @TEST_SS-3182 @Automated @SS14 @Web @discovery-platform @navbar @navbar-after-login @navbar-kost-detail
