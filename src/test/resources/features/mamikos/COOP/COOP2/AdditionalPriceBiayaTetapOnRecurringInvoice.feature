@COOP-4993 @COOP2
Feature: Additional Price Biaya Tetap On Recurring Invoice


  @TEST_COOP-3684 @TESTSET_COOP-4944 @Automated @web
  Scenario: [Add Ons - Additional Price Biaya Tetap On Invoice Recurring] Admin Batalkan Contract
  ...
  @TEST_COOP-3685 @TESTSET_COOP-4944 @Automated @web
  Scenario: [Add Ons - Additional Price Biaya Tetap On Invoice Recurring] Cancel Booking if Tenant Have Booking
  ...
  @TEST_COOP-3686 @TESTSET_COOP-4944 @Automated @web
  Scenario: [Add Ons - Additional Price Biaya Tetap On Invoice Recurring] Tenant Booking Kost
    Given user go to mamikos homepage
    When user login as tenant via phone number:
      | phone stag   | phone prod    | password     |
      | 087708777615 | 0890867321212 | mamikosqa123 |
  ...
  @TEST_COOP-3687 @TESTSET_COOP-4944 @Automated @web
  Scenario: [Add Ons - Additional Price Biaya Tetap On Invoice Recurring] Owner Accept Booking
    Given user go to mamikos homepage
  ...
  @TEST_COOP-3691 @TESTSET_COOP-4944 @Automated @web
  Scenario: [Add Ons - Additional Price Biaya Tetap On Invoice Recurring] Owner Check Additional Price Biaya Tetap Added By Admin On Manage Bills
    Given user go to mamikos homepage
    When user login as owner:
      | phone stag     | phone prod     | password     |
      | 08916727111    | 08916727111    | qwerty123    |
