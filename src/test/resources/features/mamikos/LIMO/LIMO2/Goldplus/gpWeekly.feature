...
# Currently GP weekly is deactivate
# source: https://mamikos.atlassian.net/wiki/spaces/LIMO/pages/3334733873/Perceived+Value+for+Owner+Revamp+GP+Package+Options#:~:text=weekly%20(if%20any)-,notes%20%3A%20currently%2C%20GP%20weekly%20has%20been%20deactivated%20in%20the%20banker%20whitelist%2C%20but%20conceptually%2C%20GP%20weekly%20is%20also%20included%20in%20the%20basic%20package.,-Then%20show%20long
