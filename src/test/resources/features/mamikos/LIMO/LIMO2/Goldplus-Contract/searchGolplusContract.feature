...
Feature: Search Contract Goldplus at Mamipay
  ...
  #Owner Want To Search GP Contract Search by owner phone
    ...
    Then admin verify owner phone is "087662369014" with goldplus package "[149] GoldPlus 1 4 Bulan" and status contract is "terminated"
   ...
   #Owner Want To Search GP Contract Search by owner name
    ...
    Then admin verify owner name is "Automation Limo GP Contract " with goldplus package "[149] GoldPlus 1 4 Bulan" and status contract is "terminated"
    And admin wants to reset form search

  #Owner Want To Search GP Contract Filter by GP Packages
    When admin select package "GoldPlus 1 Periode 1 Bulan"
    Then admin verify list of goldplus contracts is "[332] GoldPlus 1 1 Bulan"
    And admin wants to reset form search
