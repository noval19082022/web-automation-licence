...
Feature: Mamiads Burn Saldo
  ...
  Scenario Outline: [MamiAds][Naikkan Iklan] Switch OFF ads while saldo burn > 0 from maximal budget
    ...
    Examples:
      ...
      | burn mamiads Purwokerto Timur Banyumas | naik               | on            | Posisi iklan telah naik di hasil pencarian properti. | Hari ini Rp0 sudah dipakai dari batas pemakaian saldo Rp5.480 | Ya, Nonaktifkan | Iklan berhenti dinaikkan. | tidak-naik          | off            | Klik tombol untuk naikkan iklan | Tipe Anggaran: Rp5.480 per-hari |