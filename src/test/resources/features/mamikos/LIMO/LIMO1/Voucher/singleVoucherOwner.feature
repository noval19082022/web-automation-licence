@regression @LIMO1 @DONEMIGRATINGTONEWBOARD @viu
...
#    Then admin redirected to Update page
  ...
  @TEST_LIMO-227 @SingleVoucherList
  Scenario: [GP Voucher Admin][Single Voucher]User add Single Voucher with invoice type is recurring and invalid csv
    Given admin go to mamikos mamipay admin
    And admin login to mamipay:
      | email stag                   | email prod                   | password  |
      | automationpman03@mamikos.com | automationpman03@mamikos.com | qwerty123 |
