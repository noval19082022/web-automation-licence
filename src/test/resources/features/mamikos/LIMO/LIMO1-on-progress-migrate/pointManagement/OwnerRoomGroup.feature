...
Feature: Manage Owner Room Group (Already migrate)

#  @TEST_LIMO-47 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3301
...
#  @TEST_LIMO-45 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3302
...
#  @TEST_LIMO-49 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3303
...
#  @TEST_LIMO-54 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3304
...
#  @TEST_LIMO-52 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3305
...
#  @TEST_LIMO-46 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3306
  Scenario: [Point Management][Manage Point Owner Room Group] Verify New Owner Room Group added on Manage Point Setting Page
    When user clicks on Point Management-Owner Setting menu
    Then user verify new room group added displayed

#  @TEST_LIMO-53 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3307
...
#  @TEST_LIMO-45 @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3308
  Scenario: [Point Management][Manage Point Owner Room Group] Verify New Owner Room Group Updated on Manage Point Setting Page
    When user clicks on Point Management-Owner Setting menu
    Then user verify new room group added not displayed

#  @TEST_LIMO-51 @ownerRoomGroupPagination @continue https://mamiteam-qa3.atlassian.net/browse/LIMO-3309
...
#  @TEST_LIMO-50 @managePointOwnerRoomDisplay https://mamiteam-qa3.atlassian.net/browse/LIMO-3310
