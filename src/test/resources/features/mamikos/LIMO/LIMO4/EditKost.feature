...
Feature: Edit Kost
  ...
  Scenario: [Web][Edit Kost] Edit kost with condition user wants to edit step 1-5 without change anything
    ...
    And owner search kost "Kos oke bebek BS9Bz" on property saya page
    Then user see kos with name "Kos oke bebek BS9Bz", status "Aktif" and type "Kos Campur"
#
  ...
  Scenario: Verify kos in admin
    ...
    And admin bangkrupux search kost owner "Kos oke bebek BS9Bz" in admin kos owner page
