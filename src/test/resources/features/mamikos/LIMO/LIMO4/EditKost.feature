...
Feature: Edit Kost
  ...
  Scenario: [Web][Edit Kost] Edit kost with condition user wants to edit step 1-5 without change anything
    ...
    And owner search kost "Kos oke bebek Vvv Depok Sleman" on property saya page
    Then user see kos with name "Kos oke bebek Vvv Depok Sleman", status "Aktif" and type "Kos Putra"
  ...
  Scenario: [Web][Edit Kost] Edit kost address with valid data
    ...
    And owner search kost "Kos oke bebek Vvv Depok Sleman" on property saya page
    Then user see kos with name "Kos oke bebek Vvv Depok Sleman Depok Sleman", status "Aktif" and type "Kos Putra"
