...
Feature: Owner - Review Section
  ...
  Scenario: [Owner Dahsboard][Rating Kost]Review Section - Doesn't have any review and Listing card clicked
    ...
    Then owner will see that the text "Anda dapat membalas ulasan dan meminta penyewa mengulas kos Anda." is displayed

  ## currently entry point review only available on mweb
