...
Feature: Inquiry and Create Manual Payout
  ...
  @TEST_DOM-428 @Automated @web-covered @continue
  ...
  @TEST_DOM-511 @Automated @web-covered @continue
  ...
  @TEST_DOM-507 @Automated @web-covered @continue
  ...
  @TEST_DOM-497 @Automated @web-covered @continue
  ...
  @TEST_DOM-491 @Automated @web-covered @continue
  ...
  @TEST_DOM-518 @Automated @web-covered @continue
  ...
  @TEST_DOM-516 @Automated @web-covered @continue
  ...
  @TEST_DOM-495 @Automated @web-covered @continue
  ...
  @TEST_DOM-510 @Automated @web-covered @continue
  ...
  @TEST_DOM-519 @Automated @web-covered @createAndChangeManualPayout @continue
  ...
  @TEST_DOM-496 @Automated @web-covered @createAndChangeManualPayout @continue
  Scenario: [Mamipay][Manual Payout] Change invoice number
    Given admin go to mamikos mamipay admin
    And admin want to change invoice number into "18806898/2021/07/0002"
    Then admin see payout data successfully updated message

  @TEST_DOM-504 @Automated @web-covered @createAndChangeManualPayout @continue
