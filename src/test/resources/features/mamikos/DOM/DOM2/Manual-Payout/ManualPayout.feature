...
Feature: Inquiry and Create Manual Payout
  ...
  @TEST_COOP-5292 @Automated @web-covered @continue
  ...
  @TEST_COOP-5294 @Automated @web-covered @continue
  ...
  @TEST_COOP-5295 @Automated @web-covered @continue
  ...
  @TEST_COOP-5298 @Automated @web-covered @createAndChangeManualPayout @continue
