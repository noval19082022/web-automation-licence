...
Feature: Payment BackOffice Staging
  ...
  @TEST_COOP-5519 @Automated @web-covered
...
#    Then admin will see detail pop up "Custom Extend Contract"
  ...
  @TEST_COOP-5520 @Automated @web-covered
  ...
  @TEST_COOP-5521 @Automated @web-covered
  ...
  @TEST_COOP-5522 @Automated @web-covered
  ...
  @TEST_COOP-5523 @Automated @web-covered
  ...
  @TEST_COOP-5524 @Automated @web-covered
  ...
  @TEST_COOP-5525 @Automated @web-covered
  ...
  @TEST_COOP-5526 @Automated @web-covered
  ...
  @TEST_COOP-5527 @Automated @web-covered
  ...
  @TEST_COOP-5528 @Automated @web-covered
  ...
  @TEST_COOP-5529 @Automated @web-covered
  ...
  @TEST_COOP-5530 @Automated @web-covered
  ...
  @TEST_COOP-5531 @Automated @web-covered
  ...
  @TEST_COOP-5532 @Automated @web-covered
  ...
  @TEST_COOP-5533 @Automated @web-covered
  ...
  @TEST_COOP-5534 @Automated @web-covered
  ...
  @TEST_COOP-5535 @Automated @web-covered
  ...
  @TEST_COOP-5536 @Automated @web-covered
  ...
  @TEST_COOP-5537 @TESTSET_PAY-3276 @TESTSET_PAY-5269 @TESTSET_PF-1394 @TESTSET_PF-2238 @Automated @web-covered
...
#    Then admin verify transferred transaction for user "testing automation refund" is visible
  ...
  @TEST_COOP-5555 @Automated @web-covered
  ...
  @TEST_COOP-5556 @Automated @web-covered
...
#  Scenario: Create add ons without fill price
  ...
  @TEST_COOP-5557 @Automated @web-covered
  ...
  @TEST_COOP-5558 @Automated @web-covered
  ...
  @TEST_COOP-5559 @Automated @web-covered
  ...
  @TEST_COOP-5560 @Automated @web-covered
  ...
  @TEST_COOP-5561 @Automated @web-covered
  ...
  @TEST_COOP-5562 @Automated @web-covered
  ...
  @TEST_COOP-5563 @Automated @web-covered
  ...
  @TEST_COOP-5566 @Automated @web-covered
  ...
  @TEST_COOP-5567 @Automated @web-covered
  ...
  @TEST_COOP-5570 @Automated @web-covered
  ...
  @TEST_COOP-5572 @Automated @web-covered
  ...
  @TEST_COOP-5574 @Automated @web-covered
  ...
  @TEST_COOP-5575 @Automated @web-covered
  ...
  @TEST_COOP-5576 @Automated @web-covered
