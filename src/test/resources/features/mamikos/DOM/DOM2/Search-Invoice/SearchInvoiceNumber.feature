...
Feature: Search Invoice
  ...
  @DOM2 @searchInvoiceGlobal @TEST_SS-2831 @Automated @web-covered @continue
  ...
  @DOM2 @searchInvoiceGlobal @TEST_SS-2832 @continue
...
#    Scenario: search invoice with use invalid invoice code
  ...
  @TEST_SS-2833 @DOM2 @searchInvoiceGlobal @continue
  ...
  @TEST_SS-2834 @DOM2 @searchInvoiceGlobal @continue
  ...
  @TEST_SS-2835 @DOM2 @searchInvoiceGlobal @basedOnPaymentMethod @continue
  ...
  @DOM2 @searchInvoiceGlobal @TEST_SS-2836 @continue
  ...
  @DOM2 @searchInvoiceGlobal @TEST_SS-2837 @continue
  ...
  @TEST_SS-2839 @TEST_SS-2840 @DOM2 @searchInvoiceGlobal @continue
  ...
  @TEST_SS-2841 @DOM2 @searchInvoiceGlobal @checkStatusLogInvoice @continue
  ...
  @TEST_SS-2842 @DOM2 @searchInvoiceGlobal @continue
  ...
  @DOM2 @checkStatusLogInvoice @TEST_SS-2844 @continue
  ...
  @DOM2 @changePrice @TEST_SS-2845 @continue
  ...
  @DOM2 @SearchInvoiceByInvoiceNumber @TEST_SS-2846 @continue
  ...
  @DOM2 @searchValidInvoice @TEST_SS-2847 @continue
  ...
  @DOM2 @searchInvoiceByrecuringInvoice @TEST_SS-2848 @continue
  ...
  @TEST_SS-2850 @DOM2 @searchByNameKost
