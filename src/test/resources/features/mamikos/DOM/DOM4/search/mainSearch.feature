...
Feature: Main Search
  ...
  @TEST_SS-3236 @Automated @DOM4 @Web @discovery-platform @search @search-suggest
 ...
 @TEST_SS-3247 @Automated @DOM4 @Web @discovery-platform @search @search-clear-text
  ...
  @TEST_SS-3179 @Automated @DOM4 @Web @discovery-platform @search @search-popular-city
  ...
  @TEST_SS-3163 @Automated @DOM4 @Web @discovery-platform @search @search-popular-campus-list
