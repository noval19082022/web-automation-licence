...
#    And I search property with name "DC B" and select matching result to go to kos details page
...
#    And I should reached kos detail page
#    Then I should reached kos report section
#    When I click button report kos
#    And user enter text "try to report this kos for testing" in form kos report
