@DOM4 @KOST_DETAIL_2_SEARCH_MIGRATE
Feature: Kost detail page 2

  @TEST_SS-3195 @Automated @DOM4 @Web @discovery-platform @kost-details @report-section
  ...
  @TEST_SS-3188 @Automated @DOM4 @Web @discovery-platform @kost-details @report-section
  ...
  @TEST_SS-3224 @Automated @DOM4 @Web @discovery-platform @kost-details @owner-lower-section
  ...
  @TEST_SS-3191 @Automated @DOM4 @Web @discovery-platform @gallery @kost-details @owner-lower-section
  ...
  @TEST_SS-3222 @Automated @DOM4 @Web @discovery-platform @kost-details @recommendation
  ...
  @TEST_SS-3196 @Automated @DOM4 @Web @discovery-platform @kost-details @property-price
  ...
  @TEST_SS-3186 @Automated @DOM4 @Web @apik-badgekos @discovery-platform @kost-details @localhost
  ...
  @TEST_SS-3184 @Automated @DOM4 @Web @discovery-platform @kost-details @singgahsini-badgekos @localhost
  ...
  @TEST_SS-3187 @Automated @DOM4 @Web @discovery-platform @kost-details @owner-badges @localhost
  ...
  @TEST_SS-3185 @Automated @DOM4 @Web @discovery-platform @kost-benefit @kost-details @localhost
  ...
  @TEST_SS-3192 @Automated @DOM4 @Web @discovery-platform @review-kost @localhost
