Feature: Landing Page
  ...
  @TEST_SS-3218 @Automated @DOM4 @dikelola-mamikos @dikelola-mamikos-filter @discovery-communication @landing-page
  ...
  @TEST_SS-3252 @Automated @DOM4 @dikelola-mamikos @dikelola-mamikos-filter @discovery-communication @landing-page
  ...
  @TEST_SS-3219 @Automated @DOM4 @discovery-platform @landing-page @promo-ngebut-filter
