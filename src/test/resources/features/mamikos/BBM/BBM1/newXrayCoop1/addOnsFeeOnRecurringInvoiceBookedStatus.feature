...
Feature: [Test Execution] AT Web Staging - COOP1
	...
	@TEST_COOP-3488 @TESTSET_COOP-4944 @Automated @web
	...
	@TEST_COOP-3492 @TESTSET_COOP-4944 @Automated @web
	...
	Scenario: [Add Ons - Add Ons Fee On Recurring Invoice With Booked Status] add ons fee on recurring from add ons that added on first invoice with booked status
		Given user go to mamikos homepage
		      When user login as tenant via phone number:
		        | phone stag    | phone prod    | password     |
		        | 0891111020198 | 0891111020198 | mamikosqa123 |
