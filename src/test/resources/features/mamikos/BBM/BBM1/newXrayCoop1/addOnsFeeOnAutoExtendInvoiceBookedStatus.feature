...
Feature: addOns Fee On Auto Extend Invoice Booked Status
	...
	@TEST_COOP-3480 @TESTSET_COOP-4944 @Automated @web
	...
	@TEST_COOP-3481 @TESTSET_COOP-4944 @Automated @web
	...
	@TEST_COOP-3484 @TESTSET_COOP-4944 @Automated @web
	...
	Scenario: [Add Ons - Add Ons Fee On Auto Extend Invoice With Booked Status] Add ons Fee On Auto Extend from add ons that added on first invoice with booked status
		Given user go to mamikos homepage
		      When user login as tenant via phone number:
		        | phone stag    | phone prod    | password     |
		        | 0891111020198 | 0891111020198 | mamikosqa123 |
