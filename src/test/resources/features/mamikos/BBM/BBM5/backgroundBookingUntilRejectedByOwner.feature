...
Feature: BnB feature with background booking until rejected by owner
  ...
  Background: Tenant Booking And Reject By Owner
    ...
    And tenant search kost then go to kost details:
      ...
      | kost lombok homepage reject Tobelo Utara Halmahera Utara | kost lombok homepage reject Tobelo Utara Halmahera Utara|
    ...
    And owner choose filter kost for "kost lombok homepage reject Tobelo Utara Halmahera Utara"
