...
public class EmailTemplateSteps {
    ...
    public void user_set_the_initial_state_to_display_email_template(){
        BillingReminderPO.setEmailTemplate();

    }


    @When("user delete Email Template with content {string}")
    public void userDeleteEmailTemplateWithContent(String period) {
        BillingReminderPO.deleteBillingReminderPeriod(period);
    }

    @Then("user verify delete Email Template with content {string}")
    public void userVerifyDeleteEmailTemplateWithContent(String content) {
    ...
    @Then("user verify Email Template subject with {string}")
    public void userVerifyEmailTemplateSubjectWith(String subject) {
    ...
    @Then("user verify Email Template content with {string}")
    public void userVerifyEmailTemplateContentWith(String content) {
