...
public class OwnerDashboardPO {
    ...
    public void clickOnText(String menu) {
        playwright.waitTillLocatorIsVisible(page.getByText(menu),3.0);
        playwright.delayAndClickOn(page.getByText(menu),3.0);
    ...
    public void clickOnTextButton(String buttonText) {
        playwright.waitTillLocatorIsVisible(page.getByRole(AriaRole.BUTTON).filter(new Locator.FilterOptions().setHasText(buttonText)),3.0);
    ...
    public boolean isTextDisplayed(String text) {
        playwright.hardWait(3);
        return playwright.isLocatorVisibleAfterLoad(page.getByText(text), 3.0);
    }
