...
public class GlobalConfig {
    ...
    // Get CI/CD mode from system property (-Dcicd=true), fallback to properties file
    private static final boolean IS_CI_CD = System.getProperty("cicd") != null
        ? Boolean.parseBoolean(System.getProperty("cicd"))
        : Boolean.parseBoolean(JavaHelpers.getPropertyValue(GLOBAL_CONFIG_PROPERTIES, "ci/cd"));
